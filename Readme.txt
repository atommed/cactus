...
Ідея проекту: (може змінитися, на даний момент така:) автоматичний агрегатор подій, пов'язаних із студентським дозвіллям (вечірки, концерти, кінопокази та інші двіжухи) з відкритих джерел.
